...
/***/ function(module, exports, __webpack_require__) {
	...
	function getMatches() {
		return (0, _isomorphicFetch2.default)('/api/matches');
	}

	function getTeams() {
		return (0, _isomorphicFetch2.default)('/api/teams');
	}

	function getTeam() {
		var id = arguments.length <= 0 || arguments[0] === undefined ? '' : arguments[0];

		return (0, _isomorphicFetch2.default)('/api/teams/' + id);
	}

	function getMatch() {
		var id = arguments.length <= 0 || arguments[0] === undefined ? '' : arguments[0];

		return (0, _isomorphicFetch2.default)('/api/matches/' + id);
	}
